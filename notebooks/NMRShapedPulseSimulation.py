...
# 
# The effect of the shaped pulse on the *x*- and *y*-components is quite different from that on the *z*-component, particularly near the limit ($\pm$2500 Hz) for the inverted tophat.
